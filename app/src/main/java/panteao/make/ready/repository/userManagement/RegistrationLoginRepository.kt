...
class RegistrationLoginRepository() {
    fun getLoginAPIResponse(
        ...
        val responseApi: MutableLiveData<LoginResponseModel> = MutableLiveData()
        ...
        BaseCategoryServices.instance.loginService(username!!, pwd!!, object : LoginCallBack {
            override fun success(
                ...
                if (status) {
                    ...
                    if (response.body() != null) {
                        ...
                        val responseModel = ErrorCodesIntercepter.getInstance().Login(response)
    ...
    companion object {
        @JvmStatic
        var instance: RegistrationLoginRepository? = null
            get() {
                if (field == null) {
                    field = RegistrationLoginRepository()
                }
                if (KsPreferenceKeys.getInstance().appLanguage.equals(
                        "Thai",
                        ignoreCase = true
