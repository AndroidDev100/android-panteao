...
//        LoginRepository.userLoginRequest(this@TVLoginActivity, email, password)
...
//                    UserPreference.instance.userName = AppConstants.USER_NAME
//                    UserPreference.instance.userEmailId = AppConstants.USER_EMAIL
//                    ActivityLauncher.getInstance()
//                        .homeScreen(this@TVLoginActivity, HomeActivity::class.java)
//                    finish()
//                } else {
//                    val bundle = Bundle()
...
//            return
//        }
//        LoginRepository.facebookLoginApi(
...
//        })
    ...
    private fun callLoginStatusApi(code: String?) {
        code?.let { it1 ->
//            LoginRepository.facebookLoginStatus(
//                this@TVLoginActivity,
//                AppConstants.FACEBOOK_ID_ACCESS_TOKEN,
//                it1
//            )
...
//                })
    ...
    private fun callUserProfileApi(accessToken: String?) {
        accessToken?.let { it1 ->
//            LoginRepository.getFacebookUserProfile(
//                this@TVLoginActivity,
...
//        LoginRepository.getFbLogin(this@TVLoginActivity, fbLoginRequest)
//            .observe(this, Observer {
//                if (it != null) {
