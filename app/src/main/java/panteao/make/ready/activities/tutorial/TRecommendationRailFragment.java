...
public class TRecommendationRailFragment extends BaseBindingFragment<DetailFooterFragmentBinding> implements CommonRailtItemClickListner, MoreClickListner {
            ...
            public void onSuccess(Object item) {
                ...
                if (item instanceof RailCommonData) {
                    ...
                    if (adapterDetailRail == null) {
                        ...
                        adapterDetailRail = new CommonAdapterNew(getActivity(), railCommonDataList, TRecommendationRailFragment.this::railItemClick, TRecommendationRailFragment.this::moreRailClick);
...
*/
    ...
    public void removeTab() {
        if (context instanceof TutorialActivity) {
            ((TutorialActivity) context).removeTab(1);
        } else if (context instanceof ChapterActivity) {
            ((ChapterActivity) context).removeTab(1);
        }
    ...
    public void hideProgressBar() {
        if (context instanceof TutorialActivity) {
            ((TutorialActivity) context).isRailData = true;
            ...
            ((ChapterActivity)
                    context).dismissLoading(((ChapterActivity) context).getBinding().progressBar);
            ((ChapterActivity) context).isRailData = true;
...
//            AppCommonMethod.trackFcmEvent(railCommonData.getEnveuVideoItemBeans().get(position).getTitle(),railCommonData.getEnveuVideoItemBeans().get(position).getAssetType(),getActivity(),position);
        ...
        if (railCommonData.getScreenWidget().getType() != null && railCommonData.getScreenWidget().getLayout().equalsIgnoreCase(Layouts.HRO.name())) {
            ...
            if (railCommonData.isSeries() && AppCommonMethod.getCheckKEntryId(railCommonData.getEnveuVideoItemBeans().get(position).getkEntryId())) {
                String videoId = railCommonData.getEnveuVideoItemBeans().get(position).getBrightcoveVideoId();
                getActivity().finish();
                ...
                if (railCommonData.getEnveuVideoItemBeans().get(position).getAssetType() != null) {
                    ...
                    if (AppCommonMethod.getCheckBCID(railCommonData.getEnveuVideoItemBeans().get(position).getkEntryId())){
                        getActivity().finish();
