...
import panteao.make.ready.cardlayout.cardview.InsturctorCardView
 ...
 */
class InstructorCardPresenter(var contentType: Int) : Presenter() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): ViewHolder {
        ...
        val cardView = object : InsturctorCardView(parent.context, contentType) {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, item: Any) {
        if (item is panteao.make.ready.beanModelV3.uiConnectorModelV2.EnveuVideoItemBean) {
            val cardView = viewHolder.view as InsturctorCardView
    ...
    companion object {
        ...
        private fun updateCardBackgroundColor(view: InsturctorCardView, selected: Boolean) {
