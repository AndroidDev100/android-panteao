...
import panteao.make.ready.databinding.CustomSmallPotraitCardViewBinding
...
open class SmallPotraitCardView : BaseCardView {

    val TAG = "AssetCardView"

    private var customMenuCardViewBinding: CustomSmallPotraitCardViewBinding? = null
    ...
    private fun buildImageCardView() {
        ...
        customMenuCardViewBinding =
            DataBindingUtil.inflate(inflater, R.layout.custom_small_potrait_card_view, this, true)
    }
