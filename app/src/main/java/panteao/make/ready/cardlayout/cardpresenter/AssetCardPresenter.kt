...
import panteao.make.ready.cardlayout.cardview.AssetCardView
 ...
 */
class AssetCardPresenter(var contentType: Int,var widgetImageType:String) : Presenter() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): ViewHolder {
        ...
        val cardView = object : AssetCardView(parent.context, contentType) {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, item: Any) {
        if (item is panteao.make.ready.beanModelV3.uiConnectorModelV2.EnveuVideoItemBean) {
            val cardView = viewHolder.view as AssetCardView
    ...
    companion object {
        ...
        private fun updateCardBackgroundColor(view: AssetCardView, selected: Boolean) {
