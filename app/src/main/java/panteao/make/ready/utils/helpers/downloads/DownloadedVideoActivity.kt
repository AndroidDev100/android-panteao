 ...
 */
class DownloadedVideoActivity : BaseBindingActivity<ActivityDownloadedVideoBinding>(),BrightcovePlayerFragment.OnPlayerInteractionListener, BrightcovePlayerFragment.ChromeCastStartedCallBack {
